let Chat;_314‍.x([["default",()=>_314‍.o]]);_314‍.w("./models/chat",[["default",["Chat"],function(v){Chat=v}]]);//chat 스키마 가져오기
...
const socketEvents = (io)=>{
    io.on('connection', (socket) => { // 웹소켓 연결 시
        ...
        socket.on('room', function(room){
            ...
            _314‍.g.console.dir(room);
            _314‍.g.console.log(room.commamd);
            ...
            _314‍.g.console.log('클라이언트로 보낼 데이터 : ' + JSON.stringify(output));
