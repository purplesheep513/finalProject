let Telepathy,User,Matching;_314‍.x([["mun",()=>mun],["ans",()=>ans],["ans1",()=>ans1],["ans2",()=>ans2],["ans3",()=>ans3]]);_314‍.w("../../models/telepathy",[["default",["Telepathy"],function(v){Telepathy=v}]]);_314‍.w("../../models/user",[["default",["User"],function(v){User=v}]]);_314‍.w("../../models/matching",[["default",["Matching"],function(v){Matching=v}]]);



       const mun = async ctx=>{
    _314‍.g.console.log('접속유저: ',ctx.state.user);
